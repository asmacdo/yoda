...
% - Elevates a research object from static metadata to operational capability
% - Ranges from documented manual steps to fully automated workflows
% - Cross-cutting: applies across all dimensions (declarative vs actionable)
% - Landing zone: documentation that is genuinely followable is the MUST; programmatic execution is the SHOULD
% - Declarative vs Actionable table:
