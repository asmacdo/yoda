...
Building on this foundation, we present the STAMPED properties (Self-contained, Tracked, Actionable, Modular, Provenance-recorded, Ephemeral, and Deployable) which characterize a well-formed reproducible research object.
